...
use DKO\UIC\Generator\Template_Generator;
use DKO\UIC\Options;
...
abstract class Abstract_Admin_Page {
	 ...
	 * @var string
	 */
	protected $slug = 'wc-user-id-sequence-control';
	...
	public function get_menu_title() {
		return __( 'Woocommerce User ID Sequence Control', 'wc-user-id-sequence-control' );
	}
	...
	public function get_page_title() {
		return __( 'Woocommerce User ID Sequence Control Settings', 'wc-user-id-sequence-control' );
	}
	...
	public function get_plugins_page_title() {
		return __( 'Plugin page', 'wc-user-id-sequence-control' );
	}
